...
This package provides a Theme for the [Backpack for Laravel](https://hncoreforlaravel.com/) administration panel, that uses CoreUI v2 and implicitly Bootstrap v4. As a UI (aka UI kit, aka admin panel template) it looks and works as seen on https://backstrap.net/ - as it is a customized version of CoreUI v2.
...
**Step 2.** Go to `config/hncore/ui.php` and change your view namespace:
...
1. Remove the composer package. Eg. `composer remove hncore/theme-coreuiv2`
2. Delete the config file. Eg. `rm -rf config/hncore/theme-coreuiv2.php`
3. Install a new theme (eg. `php artisan hncore:require:theme-coreuiv4`) or change the `view_namespace` in `config/hncore/ui.php` to the theme you want to be active.
...
In ```config/hncore/theme-coreuiv2.php``` you'll notice there are variables where you can change exactly what CSS classes are placed on the HTML elements that represent the header, body, sidebar and footer:
...
![Backstrap design](https://hncoreforlaravel.com/uploads/docs-4-0/ui/examples/default.png)
...
![CoreUI design](https://hncoreforlaravel.com/uploads/docs-4-0/ui/examples/coreui.png)
...
![CoreUI design](https://hncoreforlaravel.com/uploads/docs-4-0/ui/examples/github.png)
...
![Construction or warning design](https://hncoreforlaravel.com/uploads/docs-4-0/ui/examples/blue.png)
...
![Construction or warning design](https://hncoreforlaravel.com/uploads/docs-4-0/ui/examples/construction.png)
...
![Construction or warning design](https://hncoreforlaravel.com/uploads/docs-4-0/ui/examples/red.png)
...
![Construction or warning design](https://hncoreforlaravel.com/uploads/docs-4-0/ui/examples/pink.png)
...
![Construction or warning design](https://hncoreforlaravel.com/uploads/docs-4-0/ui/examples/green.png)
...
Changes are documented here on Github. Please see the [Releases tab](https://github.com/hncore/theme-coreuiv2/releases).
...
[ico-version]: https://img.shields.io/packagist/v/hncore/theme-coreuiv2.svg?style=flat-square
[ico-downloads]: https://img.shields.io/packagist/dt/hncore/theme-coreuiv2.svg?style=flat-square

[link-packagist]: https://packagist.org/packages/hncore/theme-coreuiv2
[link-downloads]: https://packagist.org/packages/hncore/theme-coreuiv2
